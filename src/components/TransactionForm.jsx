...
<form onSubmit={handleSubmit} className="bg-white shadow-md rounded-lg p-6">
  <h2 className="text-xl font-semibold text-gray-800 mb-4">Transaction Form</h2>
  <div className="grid md:grid-cols-6 gap-6">
    ...
    <div className="col-span-1 md:col-span-3">
      ...
      <button
        type="submit"
        className="bg-purple-900 hover:bg-purple-800 text-white text-sm rounded-lg block w-full p-2.5 font-medium shadow-md transition-all duration-300"
      >
        Save Transaction
      </button>
    </div>
